...
const noActivaElement = document.querySelector('.no-activa');
const featureCards = document.querySelectorAll('.feature-card');
const activeArrow = document.querySelector('.activa span'); // Flecha de Garantía Extendida
const inactiveArrow = document.querySelector('.flecha-no-activa span'); // Flecha de Sistema de apartado

// Rotación inicial de flechas
activeArrow.style.transform = 'rotate(0deg)'; // Flecha hacia abajo
inactiveArrow.style.transform = 'rotate(-90deg)'; // Flecha hacia derecha
    ...
    featureCards.forEach((card, index) => {
        if (index >= featureCards.length - 4) {
            ...
            setTimeout(() => {
                ...
                // Rotar flechas
                activeArrow.style.transform = 'rotate(-90deg)'; // Gira a horizontal
                inactiveArrow.style.transform = 'rotate(0deg)'; // Gira a vertical
    ...
    featureCards.forEach((card, index) => {
        if (index >= featureCards.length - 4) {
            ...
            setTimeout(() => {
                ...
                // Restaurar rotación de flechas
                activeArrow.style.transform = 'rotate(0deg)'; // Vuelve a vertical
                inactiveArrow.style.transform = 'rotate(-90deg)'; // Vuelve a horizontal
